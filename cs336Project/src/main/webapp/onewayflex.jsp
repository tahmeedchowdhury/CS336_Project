...
try {
	...
	st1.executeUpdate("create temporary table t1 select * from flight where DATE(DATE_ADD(departure_time, INTERVAL 3 DAY)) >= '" + departure_date + "' and DATE(DATE_ADD(departure_time, INTERVAL -3 DAY)) <= '" + departure_date + "' and departure_airport = '" + departure_airport + "' and destination_airport <> '" + arrival_airport + "'");
