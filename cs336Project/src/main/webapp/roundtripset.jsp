...
try {
	...
	st7.executeUpdate("create temporary table r1 select * from flight where departure_time like '" + return_date + "%' and departure_airport = '" + arrival_airport + "' and destination_airport <> '" + departure_airport + "'");
